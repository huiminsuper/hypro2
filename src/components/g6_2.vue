  ...
  <div id="flowChart">
    <div class="operating">
      <el-button-group class="btn-group">
        <el-button class="btn" @click="addCircle" title="起始节点">
          <i class="iconfont icon-circle-oeps">起始节点</i>
        </el-button>
        <el-button class="btn" @click="addRect" title="常规节点">
          <i class="iconfont icon-square-oeps">常规节点</i>
        </el-button>
        <el-button class="btn" @click="addRhombus" title="条件节点">
          <i class="iconfont icon-square-ling">条件节点</i>
        </el-button>
      </el-button-group>
      <el-button-group class="btn-group">
        <el-button class="btn" @click="addLine" title="直线">
          <i class="iconfont icon-zhixian">直线</i>
        </el-button>
        <el-button class="btn" @click="addSmooth" title="曲线">
          <i class="iconfont icon-quxian">曲线</i>
        </el-button>
        <el-button class="btn" @click="addArrowLine" title="箭头直线">
          <i class="iconfont icon-jiantouzhixian">箭头直线</i>
        </el-button>
        <el-button class="btn" @click="addArrowSmooth" title="箭头曲线">
          <i class="iconfont icon-jiantouquxian">箭头曲线</i>
        </el-button>
      </el-button-group>
      <el-button-group class="btn-group">
        <el-button class="btn" @click="changeMode('edit')" title="选择模式">
          <i class="iconfont icon-chose">选择模式</i>
        </el-button>
        <el-button class="btn" @click="changeMode('drag')" title="拖拽模式">
          <i class="iconfont icon-move">拖拽模式</i>
        </el-button>
      </el-button-group>
      <el-button-group class="btn-group">
        <el-button class="btn" @click="del" style="margin-top: 5px;" title="删除">
          <i class="el-icon-delete">删除</i>
        </el-button>
        <el-button class="btn" @click="save" title="保存">
          <i class="iconfont icon-baocun">保存</i>
        </el-button>
      </el-button-group>
      <el-button-group class="btn-group">
